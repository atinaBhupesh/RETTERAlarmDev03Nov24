...
public class n_addUsers {
	...
	String newStationUser;
	 ...
	 @FindBy(xpath="//a[@href=\"http://development.retteralarm.de/admin/Users/index\"]")private WebElement list ;
     ...
     @FindBy(xpath="//input[@id=\"UserLastName\"]")private WebElement userLastNameField;
		 ...
		 @FindBy(xpath="//input[@id=\"manual_password_gen0\"]")private WebElement setPassword ;
		...
		@FindBy(xpath="//input[@placeholder=\"Please select resource.\"]")private WebElement resourceField;
		 ...
		 @FindBy(xpath="//input[@placeholder=\"Select Department\"]")private WebElement selectDepartmentForFF;
		@FindBy(xpath="//input[@placeholder=\"Select Fire Station\"]")private WebElement selectStationForFF;
		 @FindBy(xpath="//span[@id=\"select2-ffSDepartmetnBox-container\"]")private WebElement selectMainDepartmentForFF;
		...
		@FindBy(xpath="//input[@placeholder=\"Select Fire Station\"]")private WebElement stationFieldForStationUser;
			@FindBy(xpath="//button[@id=\"actionEditSubmit\"]")private WebElement saveStationUserPermission;
			 ...
			 @FindBy(xpath="(//a[@href=\"/admin/Users\"])[1]")private WebElement userlist;
		...
		public void addMultiMRUser (WebDriver driver,String deptName, String stName1 ) throws Throwable
		{
           ...
           createNew.click();
            ...
            emailField.click();
            Thread.sleep(1000);
			act.sendKeys("ghatole.dev04NovMR"+i+"@atpl.in").perform();
			...
			Thread.sleep(1000);
			act.sendKeys("dev04NovMR"+i).perform();
			Thread.sleep(1000);
...
//		Reporter.log("basic detailas save successfully.",true );
		...
		Thread.sleep(2000);
		act.sendKeys("bh1st2").sendKeys(Keys.ENTER).build().perform();
		Thread.sleep(2000);
		
		
		userFireFighter.click();
		Thread.sleep(2000);
		selectDepartmentForFF.click();
		Thread.sleep(1000);
		act.sendKeys(deptName).perform();
		Thread.sleep(2000);
...
//		selectMainDepartmentForFF.click();
//		Thread.sleep(2000);
//		act.sendKeys(deptName).perform();
//		Thread.sleep(2000);
//		act.sendKeys(Keys.ENTER).perform();
...
//		Reporter.log("User last name > dev04NovSt"+1, true);
		Reporter.log(i+")User mail id > ghatole.dev04NovMR"+i+"@atpl.in",  true);
		System.out.println();
		Thread.sleep(1000);
		userlist.click();
		Thread.sleep(1000);
		...
		public void addMultiStUser (WebDriver driver,String deptName, String stName1 ) throws Throwable
		{
           ...
           createNew.click();
            ...
            emailField.click();
            Thread.sleep(1000);
			act.sendKeys("ghatole.dev04NovSt"+i+"@atpl.in").perform();
			act.sendKeys(Keys.TAB).perform();
			Thread.sleep(1000);
			...
			userLastNameField.click();
			Thread.sleep(1000);
			act.sendKeys("dev04NovSt"+i).perform();
			Thread.sleep(1000);
		...
		if (i%2 ==0) {
			...
			stationFieldForStationUser.click();
			act.sendKeys("bh1st2").build().perform();
			Thread.sleep(2000);
			act.sendKeys(Keys.ENTER).build().perform();
			saveUserRole.click();
...
//		Reporter.log("User first name >"+"ghatole",true);
//		Reporter.log("User last name > dev04NovSt"+1, true);
		Reporter.log("User mail id > ghatole.dev04NovSt"+i+"@atpl.in",  true);
		System.out.println();
		...
		public void addMultiFfUser (WebDriver driver,String deptName, String stName1 ) throws Throwable
		{
           ...
           createNew.click();
            ...
            emailField.click();
            Thread.sleep(1000);
			act.sendKeys("ghatole.dev04Novff"+i+"@atpl.in").perform();
			act.sendKeys(Keys.TAB).perform();
			Thread.sleep(1000);
			...
			userLastNameField.click();
			Thread.sleep(1000);
			act.sendKeys("dev04Novff"+i).perform();
			Thread.sleep(1000);
