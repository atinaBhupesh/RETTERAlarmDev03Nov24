...
public class A_testClass_dailyCheckPointList extends B_baseClass {
	...
	public void addMultiMRUser() throws Throwable {
		Reporter.log(" ", true);
		Reporter.log("The process of add multi role user is started.", true);
		ff.commonForAddUers(driver);
		ff.addMultiMRUser(driver, deptName, stName1);
		Reporter.log("The process of add multi role user is complete.", true);
		Reporter.log(" ", true);
	...
	public void addMultiFfUser() throws Throwable {
		Reporter.log(" ", true);
		Reporter.log("The process of add multiple user is started.", true);
		ff.commonForAddUers(driver);
		ff.addMultiFfUser(driver, deptName, stName1);
		Reporter.log("The process of add multiple user is complete.", true);
		Reporter.log(" ", true);
	...
	public void addMultiStUser() throws Throwable {
		Reporter.log(" ", true);
		Reporter.log("The process of add multiple user is started.", true);
		ff.commonForAddUers(driver);
		ff.addMultiStUser(driver, deptName, stName1);
		Reporter.log("The process of add multiple user is complete.", true);
		Reporter.log(" ", true);
